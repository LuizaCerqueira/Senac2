...
<html lang = "pt-br">
    ...
    <body style="background-image: url(img/Clínica-Odontológica.jpg); background-repeat: no-repeat; background-size: 100%">
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #00fff2;opacity: 70%">
        ...
        <div class="container-fluid">
            <div class="row" >
                ...
                <div class="col-4 offset-1 bg-gradient rounded-3" style=" background-color:#00fff2;opacity: 80%">
                    <div >
                        ...
                        <form style="color: white">
                            ...
                            <input type="submit" name="cadastrarPaciente"
                                   class="btn btn-outline" value="Enviar"
