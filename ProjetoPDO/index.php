                        ...
                        <form method="post" action="./controller/validaLogin.php">
                            <div class="row espaco">
                                   ...
                                   if ($_SESSION['msg'] !=""){
                                    ...
                                    <label><strong style="font-size: 18px">Usuário</label>
                                </div>    
                            </div>
                            <div class="row">
                            ...
                            <div class="row espaco" style="margin-top: 20px; border-top: 3px solid #353535; border-bottom: 3px solid #353535;">
                            <img src="img/padlock.png"style= "width: 25px; position: relative;
