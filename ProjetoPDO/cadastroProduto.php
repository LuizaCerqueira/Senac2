        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-4">
                <div class="card-header bg-primary text-center border
                         text-white"><strong>Cadastro de Produtos</strong>
                </div>
                <div class="card-body border">
                    ...
                    <form method="post" action="">
                        <div class="row">
                            ...
                            <button type="button" 
                            class="btn btn-warning btInput" data-bs-toggle="modal" data-bs-target="#ModalExcluir" <?php if ($btExcluir == FALSE) echo "disabled"; ?>>
                                Excluir
                            </button>
                            <!-- Modal para excluir -->
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?php print_r($lp->getQtdEstoque()); ?></td>
                                        <td><img> src= "<?php print_r($lp->getImagem()->getNomefornecedor()); ?></td>
                                    ...
                                    <div class="modal fade" id="exampleModal<?php echo $a; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Atenção Excluir!! </h5>
